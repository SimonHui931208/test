...
public class ComplexInvertIndex {
	...
	private static class FileNameInputFormat extends FileInputFormat<Text,Text>{
		@Override
	...
	private static class InvertIndexMapper extends Mapper<Text, Text,Text,IntWritable>{
		...
		protected void map(Text key, Text value,
			...
			for(String str : strs){
				context.write(new Text( str+"#"+key.toString() ),new IntWritable(1));
			}
		}
	}
	...
	public static void main(String[] args) throws Exception {
		...
		Job job = Job.getInstance(config,"复杂倒排索引");
